...
btu7=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="7",bg="black",command=lambda:btnclick(7)).grid(row=1,column=0)

btu8=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
...
Addition=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="+",bg="black",command=lambda:btnclick("+")).grid(row=1,column=3)
#==========================================================================
btn4=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="4",bg="black",command=lambda:btnclick(4)).grid(row=2,column=0)

btn5=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="5",bg="black",command=lambda:btnclick(5)).grid(row=2,column=1)

btn6=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
...
#==========================================================================
btn1=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
...
btn3=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="3",bg="black",command=lambda:btnclick(3)).grid(row=3,column=2)

Multiply=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
...
btnEquals=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="=",bg="black",command=btnEqualsInput).grid(row=4,column=2)

Division=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
